...
/*!
 ATTENTION : LORS DE L'ENVOI DU PROGRAMME, SI LE JUMPER D8 EST MIS, IL FAUT APPUIER SUR LE BOUTON 
 INDIQUÉ "LEFT" LORS DES PREMIÈRES SECONDES D'ENVOI DU PROGRAMME, SOUS PEINE D'ERREUR LE CAS ECHÉANT
*/
